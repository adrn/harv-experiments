...
from ampcal.grid import enumerate_cells, seeds
from ampcal.mpi import balance, under_mpi_launcher
from ampcal.run import _estimate_cost
...
def test_no_mpi_import_without_a_launcher(monkeypatch) -> None:
    ...
    """
    from ampcal import mpi as kmpi
